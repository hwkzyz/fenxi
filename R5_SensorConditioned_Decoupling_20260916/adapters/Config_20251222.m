...
cfg.paths.strainRoot = '';
cfg.paths.staticGapLibrary = '';
cfg.paths.referenceBladeGapAnalysis = '';
cfg.paths.functions = rootDir;
cfg.paths.preparation = rootDir;
cfg.paths.foundation = fullfile(rootDir, '..', 'inputs', '20251222', 'foundation');
cfg.paths.calibration = fullfile(rootDir, '..', 'inputs', '20251222', 'calibration');
cfg.paths.gapAware = rootDir;
cfg.paths.utilities = fullfile(rootDir, '..', 'core');
cfg.paths.inputs = fullfile(rootDir, '..', 'inputs', '20251222');
...
cfg.paths.results = fullfile(rootDir, '..', 'results', '20251222');
...
cfg.r5.foundationReplayToleranceMv = 5.0;
