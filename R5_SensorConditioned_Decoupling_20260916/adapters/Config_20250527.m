...
cfg.paths.rawDatasetRoot = '';
cfg.paths.staticGapLibrary = fullfile(rootDir, '..', 'inputs', '20250527', 'calibration');
cfg.paths.referenceBladeGapAnalysis = '';
cfg.paths.functions = rootDir;
cfg.paths.preparation = rootDir;
cfg.paths.foundation = fullfile(rootDir, '..', 'inputs', '20250527', 'foundation');
cfg.paths.calibration = fullfile(rootDir, '..', 'inputs', '20250527', 'calibration');
cfg.paths.gapAware = rootDir;
cfg.paths.utilities = fullfile(rootDir, '..', 'core');
cfg.paths.inputs = fullfile(rootDir, '..', 'inputs', '20250527');
...
cfg.paths.preparedFoundation = fullfile(cfg.paths.inputs, 'prepared', 'foundation');
cfg.paths.results = fullfile(rootDir, '..', 'results', '20250527');
...
% The low-speed calibration provides a frozen absolute response-surface state.
...
cfg.r5.minSupportFraction = 0.80;
% Foundation is a comparison baseline, not an R5 acceptance gate.
cfg.r5.auditFoundationReplay = false;
cfg.r5.foundationReplayUsedForAcceptance = false;
cfg.r5.foundationReplayToleranceMv = 1e-6;
cfg.r5.staticTiltCarrier = 'absolute_surface_state';
cfg.r5.staticTiltSource = 'low_speed_absolute_surface_localization';
...
cfg.files.lowSpeedTemplate = fullfile(rootDir, '..', 'inputs', '20250527', 'frozen', ...
