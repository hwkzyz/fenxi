...
Known=struct('target',{},'anchor',{},'rmse_anchor',{},'nrmse_other',{}, ...
    'corr_other',{},'peak_x_mae',{},'peak_amp_mae',{},'z_hat',{},'g_hat',{},'g_error',{});
...
for target=targetFaces
    ...
    for ia=1:nGap
        ...
        Known(caseNo)=struct('target',target,'anchor',ia,'rmse_anchor',dist(ib), ...
            ...
            'peak_x_mae',px,'peak_amp_mae',pa,'z_hat',NaN,'g_hat',gap(ia),'g_error',0);
        ...
        Joint(jointNo)=struct('target',target,'anchor',ia,'rmse_anchor',J(izg,igg), ...
            ...
            'peak_x_mae',pxj,'peak_amp_mae',paj,'z_hat',zjoint,'g_hat',gjoint,'g_error',gjoint-gap(ia));
        if ia==1
...
plot(joint.g_hat,joint.z_hat,'wp','MarkerFaceColor','k','MarkerSize',8);
