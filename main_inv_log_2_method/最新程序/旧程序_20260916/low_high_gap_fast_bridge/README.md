...
available through `cfg.route30ForwardModel="low_increment"`; its cached,
vectorized VP path and amplitude/phase re-estimation are now the current
implementation. The original scripts in this directory remain validation and
regression drivers.
