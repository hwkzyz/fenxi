function T = make_cb_summary(R, truth)
%make_cb_summary  Build a one-row summary table for cb ablation methods.
...
T = table(R.method, R.g_used, abs(R.g_used - truth.g_high), ...
    ...
    R.rmse, R.eta_g, R.c_hat, R.b_hat, R.elapsed_s, ...
    'VariableNames', {'method','gap_used_mm','gap_error_mm', ...
    'f1_Hz','f2_Hz','A1_mm','A2_mm','mean_freq_error_Hz', ...
    'mean_amp_error_mm','rmse','eta_g','c_hat','b_hat','elapsed_s'});
end
