function Result = Run_15b_StateMatchedCommonThresholdAudit()
%RUN_15B_STATEMATCHEDCOMMONTHRESHOLDAUDIT Apply common thresholds to SM-delta.
...
for g=gaps
    ...
    D=D(:,{'coordinate_mode','g_truth_mm','A_true_mm','replicate_index','high_seed','g_query_mm',...
        'eo_est','A_est_mm','rmse_V','threshold_fixed_mm','threshold_adaptive_mm',...
        'threshold_state_matched_mm','fp_fixed_threshold','fp_adaptive_threshold','fp_state_matched_threshold'});
    All=[All;D]; %#ok<AGROW>
end
Summary=table();
for g=gaps
