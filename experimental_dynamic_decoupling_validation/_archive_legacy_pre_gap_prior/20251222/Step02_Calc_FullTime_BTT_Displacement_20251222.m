...
resultFile = fullfile(caseOutputDir, 'Step3_Result_20251222.mat');
...
if isfile(resultFile) && ~forceRebuild
    ...
    result = Step3_Displacement_Calculation_20251222(caseName, ...
...
save(fullfile(outDir, 'Step02_FullTime_BTT_Displacement_20251222.mat'), ...
    'result', '-v7.3');
...
figure('Name', '20251222 Step02 full-time BTT displacement', ...
...
figFile = fullfile(outDir, 'Step02_FullTime_BTT_Displacement_20251222.png');
saveas(gcf, figFile);

fprintf('\nStep02 complete. Saved validation copy:\n  %s\n', ...
    fullfile(outDir, 'Step02_FullTime_BTT_Displacement_20251222.mat'));
