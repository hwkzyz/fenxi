...
[F_omega_deg_s, speed_diagnostic] = build_low_speed_speed_interpolant_local(case_data.opr_times(:), cfg.blades_num);
...
function [F_omega_deg_s, diagnostic] = build_low_speed_speed_interpolant_local(opr_times, blades_num)
opr_times = opr_times(:);
...
empty = struct( ...
    ...
    'x_domain', [NaN NaN], 'baseline', NaN, 'amplitude', NaN, ...
