function cfg = build_single_sync_experiment_config_20251222()
%BUILD_SINGLE_SYNC_EXPERIMENT_CONFIG_20251222
% Central config for the rewritten 20251222 single-sync SG pipeline.
...
cfg.step4_fixed_window_plan_mat = fullfile(cfg.window_scan_output_dir, 'Step4_StableWindowPlan_20251222.mat');
cfg.step4_fixed_window_plan_csv = fullfile(cfg.window_scan_output_dir, 'Step4_StableWindowPlan_20251222.csv');
...
cfg = resolve_single_sync_experiment_paths_20251222(cfg);
end
