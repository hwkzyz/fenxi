...
matFile = fullfile(outDir, 'Step05H_OffsetCorrected_Shared_Response_Surface_20251222.mat');
csvFile = fullfile(outDir, 'Step05H_OffsetCorrected_Shared_Response_Surface_Fit_20251222.csv');
summaryCsv = fullfile(outDir, 'Step05H_OffsetCorrected_Shared_Response_Surface_BladeSummary_20251222.csv');
figFile = fullfile(figDir, 'Step05H_OffsetCorrected_Shared_Surface_20251222.png');
