...
correctedLibFile = fullfile(outDir, sprintf('Step06F_TiltCorrected_GapLibrary_20251222_B%d_%s.mat', ...
...
matFile = fullfile(outDir, sprintf('Step07C_LowTemplateTiltGap_VPFullWave_20251222_B%d_%s.mat', ...
    cfg.targetBlade, sensorTag));
trendCsv = fullfile(outDir, sprintf('Step07C_LowTemplateTiltGap_VPFullWave_Trend_20251222_B%d_%s.csv', ...
    cfg.targetBlade, sensorTag));
summaryCsv = fullfile(outDir, sprintf('Step07C_LowTemplateTiltGap_VPFullWave_Summary_20251222_B%d_%s.csv', ...
    cfg.targetBlade, sensorTag));
figTrend = fullfile(figDir, sprintf('Step07C_Trend_20251222_B%d_%s.png', cfg.targetBlade, sensorTag));
figBest = fullfile(figDir, sprintf('Step07C_BestWindow_Collapse_20251222_B%d_%s.png', cfg.targetBlade, sensorTag));
figGap = fullfile(figDir, sprintf('Step07C_GapIdentification_20251222_B%d_%s.png', cfg.targetBlade, sensorTag));
