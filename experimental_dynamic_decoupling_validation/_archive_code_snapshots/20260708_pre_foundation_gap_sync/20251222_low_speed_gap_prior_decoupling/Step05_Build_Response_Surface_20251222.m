...
%% 5. Save outputs
matFile = fullfile(outDir, 'Step05_Response_Surface_20251222.mat');
csvFile = fullfile(outDir, 'Step05_Response_Surface_Fit_20251222.csv');
save(matFile, 'responseSurface', '-v7.3');
motionCsvFile = fullfile(outDir, 'Step05_Calibration_Motion_20251222.csv');
baselineCsvFile = fullfile(outDir, 'Step05_Static_Gap_Continuous_Baseline_20251222.csv');
