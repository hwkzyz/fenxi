...
% final EO. This script compares nested static correction models on top of
% the low-speed template:
%
...
%
% Paper-facing main output uses gap_tilt. gap_only is retained as the
% scalar-gap ablation, and gap_tilt_shift is retained as the over-flexible
% shift ablation.
%
...
Result.method = 'gap_tilt_main_with_nested_static_warp_ablation_vp_full_wave';
Result.description = ['Main result uses a gap+tilt high-speed static increment. ' ...
    'VP Top-K provides only the EO candidate set; gap_tilt jointly identifies EO, vibration, gap increment and a small tilt increment inside that set with the full waveform objective. ' ...
    'Fixed, gap_only and gap_tilt_shift remain diagnostic ablation models.'];
Result.cfg = cfg;
