...
correctedLibFile = fullfile(outDir, sprintf('Step06G_PerBladeWeighted_GapLibrary_20251222_B%d_%s.mat', ...
...
matFile = fullfile(outDir, sprintf('Step07D_PerBladeWeightedGap_VPFullWave_20251222_B%d_%s.mat', ...
    cfg.targetBlade, sensorTag));
trendCsv = fullfile(outDir, sprintf('Step07D_PerBladeWeightedGap_VPFullWave_Trend_20251222_B%d_%s.csv', ...
    cfg.targetBlade, sensorTag));
summaryCsv = fullfile(outDir, sprintf('Step07D_PerBladeWeightedGap_VPFullWave_Summary_20251222_B%d_%s.csv', ...
    cfg.targetBlade, sensorTag));
figTrend = fullfile(figDir, sprintf('Step07D_Trend_20251222_B%d_%s.png', cfg.targetBlade, sensorTag));
figBest = fullfile(figDir, sprintf('Step07D_BestWindow_Collapse_20251222_B%d_%s.png', cfg.targetBlade, sensorTag));
figGap = fullfile(figDir, sprintf('Step07D_GapIdentification_20251222_B%d_%s.png', cfg.targetBlade, sensorTag));
