...
resultFile = fullfile(caseOutputDir, 'Step3_Spectrum_RPM_Alignment_20250527.mat');
...
if needRebuild
    ...
    result = Step3_Align_StrainSpectrum_With_RPM_20250527(caseName, ...
        cfg.step3_default_alignment_offset_sec, cfg.step3_align_order_candidates, ...
        cfg.step3_align_freq_plot_hz, showPlots, strainPreprocessMethod);
end
...
save(fullfile(outDir, 'Step03_Strain_OPR_Vibration_Window_20250527.mat'), ...
    'result', '-v7.3');
...
figure('Name', '20250527 Step03 strain-OPR vibration location', ...
...
figFile = fullfile(outDir, 'Step03_Strain_OPR_Vibration_Window_20250527.png');
saveas(gcf, figFile);

fprintf('\nStep03 complete. Saved validation copy:\n  %s\n', ...
    fullfile(outDir, 'Step03_Strain_OPR_Vibration_Window_20250527.mat'));
