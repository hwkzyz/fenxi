...
matFile = fullfile(outDir, sprintf('Step07I_OffsetTiltSharedGap_VPFullWave_20250527_B%d_%s.mat', ...
    cfg.targetBlade, sensorTag));
trendCsv = fullfile(outDir, sprintf('Step07I_OffsetTiltSharedGap_VPFullWave_Trend_20250527_B%d_%s.csv', ...
    cfg.targetBlade, sensorTag));
summaryCsv = fullfile(outDir, sprintf('Step07I_OffsetTiltSharedGap_VPFullWave_Summary_20250527_B%d_%s.csv', ...
    cfg.targetBlade, sensorTag));
figTrend = fullfile(figDir, sprintf('Step07I_Trend_20250527_B%d_%s.png', cfg.targetBlade, sensorTag));
figBest = fullfile(figDir, sprintf('Step07I_BestWindow_Collapse_20250527_B%d_%s.png', cfg.targetBlade, sensorTag));
figGap = fullfile(figDir, sprintf('Step07I_GapIdentification_20250527_B%d_%s.png', cfg.targetBlade, sensorTag));
