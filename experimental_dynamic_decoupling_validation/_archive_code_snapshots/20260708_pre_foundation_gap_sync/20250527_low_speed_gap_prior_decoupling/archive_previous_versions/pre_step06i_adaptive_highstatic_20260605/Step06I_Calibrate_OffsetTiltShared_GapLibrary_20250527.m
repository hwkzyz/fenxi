...
outputTag = [sensorTag resultSuffix];
matFile = fullfile(outDir, sprintf('Step06I_OffsetTiltShared_GapLibrary_20250527_B%d_%s.mat', ...
    cfg.targetBlade, outputTag));
csvFile = fullfile(outDir, sprintf('Step06I_OffsetTiltShared_GapLibrary_Calibration_20250527_B%d_%s.csv', ...
    cfg.targetBlade, outputTag));
highCsvFile = fullfile(outDir, sprintf('Step06I_OffsetTiltShared_GapLibrary_HighStaticCheck_20250527_B%d_%s.csv', ...
    cfg.targetBlade, outputTag));
figLow = fullfile(figDir, sprintf('Step06I_LowTemplate_OffsetTiltShared_Fit_20250527_B%d_%s.png', ...
    cfg.targetBlade, outputTag));
figPath = fullfile(figDir, sprintf('Step06I_TiltPath_In_OffsetTiltShared_Library_20250527_B%d_%s.png', ...
    cfg.targetBlade, outputTag));
figHigh = fullfile(figDir, sprintf('Step06I_HighStatic_OffsetTiltShared_Check_20250527_B%d_%s.png', ...
    cfg.targetBlade, outputTag));
