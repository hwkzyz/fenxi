...
method.frequency_decision = ['single-window EO is selected by adaptive VP candidates plus full-waveform RMSE refinement; ' ...
...
for iEO = 1:numel(eo_candidates)
    ...
    %   sin coefficient a
    %   cos coefficient b
    % The formal foundation route does not include eta_s in the linear VP
    % EO screen or in the later full waveform refinement.
    X = [-Tp, -Tp .* s, -Tp .* c];
