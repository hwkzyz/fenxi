...
% VERSION: FOUNDATION_MAINPULSE_ADAPTIVE_NOETA_20260706
%
% Key logic:
...
%   5. The formal 20251222 foundation route is NoEta. Sensor/static eta
...
S = struct();
S.method_name = 'foundation_mainpulse_adaptive_noeta';
S.version = 'FOUNDATION_MAINPULSE_ADAPTIVE_NOETA_20260706';
...
if ~isempty(fit_sensor_eta_env)
    error('STEP05_FIT_SENSOR_ETA changes the method route; official foundation Step05 is NoEta.');
end
...
method.parameter_bound_policy = 'formal A and dx_c bounds are enforced during objective evaluation and reporting; eta is not fitted in the main route';
