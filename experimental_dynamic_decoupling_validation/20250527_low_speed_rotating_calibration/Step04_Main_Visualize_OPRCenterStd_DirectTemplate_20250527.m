...
bundle = WR.bundle;
R = WR.Result;
fig = figure('Name', sprintf('20250527 reconstructed waveform comparison W%02d', windowID), ...
...
fig = figure('Name', sprintf('20250527 single-pass reconstructed waveform detail W%02d', windowID), ...
