...
%% Parameters to tune
P.name.templateSuffix = 'Base';
P.name.dynamicSuffix = 'Base';
P.name.resultSuffix = 'Tmp_S13_Base_Dx035_NoEta_PrevWinPhaseSafe';

P.step03.analysisSensors = [1 3];
...
templateFile = fullfile(routeDir, 'output', 'templates', ...
    'Template_LowSpeedRotating_B1_S13_20250527.mat');
dynamicFile = fullfile(routeDir, 'output', 'dynamic_maps', ...
    'DynamicMap_B1_S13_SlidingWindows_20250527.mat');
