%% Step03D_Run_TemplateOnly_SGLikeSingleSync_20250527
...
method = struct();
method.name = 'template_only_sg_like_single_sync';
...
result_file = fullfile(result_dir, sprintf('Result_TemplateOnlySGLikeSingleSync_B%d_%s_20250527.mat', ...
...
fprintf('\n=== Step03D: template-only SG-like single-sync identification ===\n');
