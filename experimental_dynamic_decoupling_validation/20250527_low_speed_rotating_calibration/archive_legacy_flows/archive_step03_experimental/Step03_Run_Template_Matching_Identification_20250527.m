%% Step03_Run_Template_Matching_Identification_20250527
% Proposed-method identification with the same sliding-window settings as
% the old SG Step5 program.
%
% Same settings:
%   cfg.target_blades        = 1
...
result_file = fullfile(result_dir, sprintf('Result_ProposedFixedTemplateSliding_B%d_%s_20250527.mat', ...
...
fprintf('Initial EO from coarse scans: EO %d\n', global_eo);
