%% Step03_01_Run_DirectLowSpeedWaveform_20250527
% Low-speed-template-only identification using the same single-sync logic
% as the super-Gaussian Step5 route.
%
...
method = struct();
method.name = 'direct_low_speed_waveform_full_eo';
...
result_file = fullfile(result_dir, sprintf('Result_Step03_01_DirectLowSpeedWaveform_B%d_%s%s_20250527.mat', ...
...
fprintf('\n=== Step03_01: direct low-speed waveform optimization ===\n');
