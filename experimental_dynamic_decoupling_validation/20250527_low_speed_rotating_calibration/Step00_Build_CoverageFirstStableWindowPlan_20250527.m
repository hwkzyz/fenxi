%% Step00_Build_CoverageFirstStableWindowPlan_20250527
...
C = CaseConfig();
oldProgramDir = fullfile(routeDir, 'archive_legacy_flows', 'old_programs');
legacyScript = fullfile(oldProgramDir, 'Step01_00_Build_CoverageFirstStableWindowPlan_20250527.m');
