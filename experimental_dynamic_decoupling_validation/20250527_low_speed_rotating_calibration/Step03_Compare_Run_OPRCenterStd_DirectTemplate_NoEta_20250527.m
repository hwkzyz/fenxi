%% Step03_Compare_Run_OPRCenterStd_DirectTemplate_NoEta_20250527
...
%% Step03_Compare_VPTop3SynchronousWaveform_NoEta_20250527
...
q = min(max(cfg.sensor_eta_adaptive_quantile, 0), 100); %#ok<NASGU>
