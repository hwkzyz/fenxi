function experiment_case = Prepare_experiment_case_single_sync_20251222(cfg, show_plots, save_output)
%PREPARE_EXPERIMENT_CASE_SINGLE_SYNC_20251222
...
if save_output
    ...
    fprintf('Saved 20251222 experiment case to %s\n', cfg.case_file);
else
    fprintf('Prepared 20251222 experiment case in memory for Blade %d.\n', cfg.target_blade);
end
...
fig = figure('Name', sprintf('20251222 Experiment Case - %s', cfg.dynamic_case_name), ...
