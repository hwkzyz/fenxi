function Sensor_Config = Step1_Build_Sensor_Config_20251222(show_plots)
%STEP1_BUILD_SENSOR_CONFIG_20251222 Build Step1-style fingerprint config for 20251222.
...
case_data = Extract_BTT_Features_20251222(cfg.low_speed_case, cfg);
...
save(fullfile(cfg.reference_output_dir, 'Sensor_Config_20251222.mat'), 'Sensor_Config');
save(fullfile(cfg.reference_output_dir, 'Sensor_Config.mat'), 'Sensor_Config');
writetable(summary_table, fullfile(cfg.reference_output_dir, 'Sensor_Config_Summary_20251222.csv'));

fprintf('Saved Sensor_Config to:\n  %s\n', fullfile(cfg.reference_output_dir, 'Sensor_Config_20251222.mat'));
...
fig1 = figure('Name', '20251222 Step1 Fingerprint Alignment', ...
...
fig2 = figure('Name', '20251222 Step1 Standard Relative Angles', ...
...
figure('Name', '20251222 Step1 Low-Speed RPM', ...
...
figure('Name', '20251222 Step1 Summary Table', ...
