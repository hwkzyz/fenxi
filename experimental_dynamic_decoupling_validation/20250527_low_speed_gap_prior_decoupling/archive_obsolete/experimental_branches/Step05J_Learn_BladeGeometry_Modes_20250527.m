...
surfaceFile = fullfile(outDir, 'Step05H_OffsetCorrected_Shared_Response_Surface_20250527.mat');
...
BladeGeometryModes.dataset = '20250527';
...
matFile = fullfile(outDir, 'Step05J_BladeGeometry_Modes_20250527.mat');
geometryCsv = fullfile(outDir, 'Step05J_BladeGeometry_Modes_20250527.csv');
fitCsv = fullfile(outDir, 'Step05J_BladeGeometry_Modes_Fit_20250527.csv');
figFile = fullfile(figDir, 'Step05J_BladeGeometry_Modes_20250527.png');
