...
CorrectedGapLibrary.dataset = '20250527';
...
matFile = fullfile(outDir, sprintf('Step06F_TiltCorrected_GapLibrary_20250527_B%d_%s.mat', ...
    cfg.targetBlade, sensorTag));
csvFile = fullfile(outDir, sprintf('Step06F_TiltCorrected_GapLibrary_Calibration_20250527_B%d_%s.csv', ...
    cfg.targetBlade, sensorTag));
highCsvFile = fullfile(outDir, sprintf('Step06F_TiltCorrected_GapLibrary_HighStaticCheck_20250527_B%d_%s.csv', ...
    cfg.targetBlade, sensorTag));
figLow = fullfile(figDir, sprintf('Step06F_LowTemplate_TiltCorrected_Fit_20250527_B%d_%s.png', ...
    cfg.targetBlade, sensorTag));
figPath = fullfile(figDir, sprintf('Step06F_TiltPath_In_RawGapLibrary_20250527_B%d_%s.png', ...
    cfg.targetBlade, sensorTag));
figHigh = fullfile(figDir, sprintf('Step06F_HighStatic_TiltCorrected_Check_20250527_B%d_%s.png', ...
    cfg.targetBlade, sensorTag));
