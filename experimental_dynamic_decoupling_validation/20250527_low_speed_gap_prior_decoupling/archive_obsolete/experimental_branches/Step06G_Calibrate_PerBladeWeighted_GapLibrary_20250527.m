...
perBladeFile = fullfile(outDir, 'Step05G_PerBlade_Response_Surface_20250527.mat');
...
PerBladeWeightedGapLibrary.dataset = '20250527';
...
matFile = fullfile(outDir, sprintf('Step06G_PerBladeWeighted_GapLibrary_20250527_B%d_%s.mat', ...
    cfg.targetBlade, sensorTag));
fitCsv = fullfile(outDir, sprintf('Step06G_PerBladeWeighted_GapLibrary_Fit_20250527_B%d_%s.csv', ...
    cfg.targetBlade, sensorTag));
weightCsv = fullfile(outDir, sprintf('Step06G_PerBladeWeighted_GapLibrary_Weights_20250527_B%d_%s.csv', ...
    cfg.targetBlade, sensorTag));
figFit = fullfile(figDir, sprintf('Step06G_PerBlade_LowTemplate_Fits_20250527_B%d_%s.png', ...
    cfg.targetBlade, sensorTag));
figWeights = fullfile(figDir, sprintf('Step06G_BladeFamily_Weights_20250527_B%d_%s.png', ...
    cfg.targetBlade, sensorTag));
