function experiment_case = Prepare_experiment_case_single_sync_20250527(cfg, show_plots, save_output)
%PREPARE_EXPERIMENT_CASE_SINGLE_SYNC_20250527
...
if save_output
    ...
    fprintf('Saved 20250527 experiment case to %s\n', cfg.case_file);
else
    fprintf('Prepared 20250527 experiment case in memory for Blade %d.\n', cfg.target_blade);
end
...
fig = figure('Name', sprintf('20250527 Experiment Case - %s', cfg.dynamic_case_name), ...
