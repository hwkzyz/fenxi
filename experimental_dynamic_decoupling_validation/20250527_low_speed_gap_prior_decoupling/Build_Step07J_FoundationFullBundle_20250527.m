...
% Rebuilds the matching 20250527 btt_data_foundation Step05 route with
...
foundationDir = fullfile(rootDir, '20250527_btt_data_foundation');
...
setenv('STEP05_OUTPUT_TAG', 'fullbundle_gap_step07j');
