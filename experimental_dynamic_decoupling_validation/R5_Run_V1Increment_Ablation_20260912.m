...
q=load(oldFile,'Result'); w=q.Result.WindowResult; cfg=struct(); cfg.dataset='ablation'; cfg.case=struct('targetBlade',1); cfg.frequency=struct('candidateTopK',3,'maxOffsetHz',2); cfg.r5=struct('useV1DynamicIncrement',true,'auditAllEO',true,'useNestedFoundationAnchor',false);
