...
mainLegacyDir = fullfile(validationRoot, '20251222_low_speed_gap_prior_decoupling', 'legacy');
...
fig = figure('Name', '20251222 Step01 OPR-center and blade timing', ...
...
if P.view.saveFigures
    ...
    saveas(fig, fullfile(outDir, 'Step01_OPRCenter_Blade_Timing_20251222.png'));
end
