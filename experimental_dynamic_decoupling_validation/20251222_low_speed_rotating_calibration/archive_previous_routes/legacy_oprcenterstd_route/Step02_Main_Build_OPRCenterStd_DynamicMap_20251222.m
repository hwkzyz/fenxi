...
legacyDir = fullfile(validationRoot, '20251222_low_speed_gap_prior_decoupling', 'legacy');
...
P.name.dynamicSuffix = sprintf('%s_Main20L_W3S1_GradientXRange030_OPRCenterStd', ...
    resonanceSelection.shortTag);
...
P.path.sensorConfigFile = fullfile(baseCfg.reference_output_dir, 'Sensor_Config_20251222.mat');

P.step02.analysisSensors = C.sensorIds;
P.step02.analysisStartTime = resonanceSelection.analysisStartTimeSec;
P.step02.targetLaps = resonanceSelection.targetBladePasses;
P.step02.windowLaps = resonanceSelection.windowBladePasses;
P.step02.slidingStepLaps = resonanceSelection.slidingStepBladePasses;
P.step02.resonanceSelection = resonanceSelection;
P.step02.resonanceCatalog = resonanceCatalog;
...
P.step02.oprPulsesPerRev = baseCfg.blades_num;
...
fprintf('Resonance region: %s, Step04 interval %.4f-%.4f s, EO%d near %.2f Hz\n', ...
    P.step02.resonanceSelection.tag, ...
    P.step02.resonanceSelection.regionStartSec, ...
    P.step02.resonanceSelection.regionEndSec, ...
    P.step02.resonanceSelection.dominantOrder, ...
    P.step02.resonanceSelection.dominantFreqHz);
...
if ~isfile(template_file)
    error('Template file not found after resolver: %s', template_file);
end
...
cfg.resonance_region_id = P.step02.resonanceSelection.regionId;
cfg.resonance_region_tag = P.step02.resonanceSelection.tag;
cfg.resonance_region_short_tag = P.step02.resonanceSelection.shortTag;
cfg.resonance_region_start_sec = P.step02.resonanceSelection.regionStartSec;
cfg.resonance_region_end_sec = P.step02.resonanceSelection.regionEndSec;
cfg.resonance_dominant_order = P.step02.resonanceSelection.dominantOrder;
cfg.resonance_dominant_freq_hz = P.step02.resonanceSelection.dominantFreqHz;
...
DynamicMap.ResonanceSelection = P.step02.resonanceSelection;
DynamicMap.ResonanceCatalog = P.step02.resonanceCatalog;
