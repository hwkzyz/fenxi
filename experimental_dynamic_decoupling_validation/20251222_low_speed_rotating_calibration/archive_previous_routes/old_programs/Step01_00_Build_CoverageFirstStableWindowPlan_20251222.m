%% Step01_00_Build_CoverageFirstStableWindowPlan_20251222
...
plan_csv = fullfile(plan_dir, sprintf('Step01_CoverageFirstStableWindowPlan_B%d_%s_20251222.csv', ...
    target_blade, sensor_tag));
plan_mat = fullfile(plan_dir, sprintf('Step01_CoverageFirstStableWindowPlan_B%d_%s_20251222.mat', ...
    target_blade, sensor_tag));
candidate_csv = fullfile(plan_dir, sprintf('Step01_CoverageFirstStableWindowCandidates_B%d_%s_20251222.csv', ...
    target_blade, sensor_tag));
...
for is = 1:numel(analysis_sensors)
    ...
    for lap_count = candidate_lap_counts(:).'
        ...
        for start_offset_lap = 0:scan_step_laps:max_offset
...
exportgraphics(fig, fullfile(figure_dir, sprintf('Step01_00_CandidateScore_B%d_%s_20251222.png', ...
    target_blade, sensor_tag)), 'Resolution', 300);
exportgraphics(fig, fullfile(figure_dir, sprintf('Step01_00_CandidateScore_B%d_%s_20251222.pdf', ...
...
set(gca, 'FontName', 'Times New Roman', 'FontSize', 8.5, 'TickDir', 'in', 'Box', 'on');
exportgraphics(fig, fullfile(figure_dir, sprintf('Step01_00_DomainCoverage_B%d_%s_20251222.png', ...
    target_blade, sensor_tag)), 'Resolution', 300);
exportgraphics(fig, fullfile(figure_dir, sprintf('Step01_00_DomainCoverage_B%d_%s_20251222.pdf', ...
    target_blade, sensor_tag)), 'ContentType', 'vector');
end
...
exportgraphics(fig, fullfile(figure_dir, sprintf('Step01_00_SelectedClouds_B%d_%s_20251222.png', ...
    target_blade, sensor_tag)), 'Resolution', 300);
exportgraphics(fig, fullfile(figure_dir, sprintf('Step01_00_SelectedClouds_B%d_%s_20251222.pdf', ...
    target_blade, sensor_tag)), 'ContentType', 'vector');
end
