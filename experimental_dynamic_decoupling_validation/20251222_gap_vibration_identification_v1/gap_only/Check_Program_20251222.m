...
for i = 1:13
    ...
    if i == 5 && numel(hit) > 1
        % Main05 has two historical entry points; the frozen formal V1
        % entry is the Foundation route, while R5 is retained for replay.
        hit = hit(strcmp({hit.name}, 'Main05_Foundation_NoGap_VPTopK_20251222.m'));
    end
