...
% Experimental branch. It does not overwrite Step05/Step05H outputs.
%
...
step05File = fullfile(outDir, 'Step05_Response_Surface_20251222.mat');
if ~isfile(step05File)
    step05File = packageCfg.files.responseSurface;
end
offsetFile = fullfile(packageCfg.paths.referenceBladeGapAnalysis, 'results', ...
...
matFile = fullfile(outDir, 'Step05I_OffsetTilt_Shared_Response_Surface_20251222.mat');
fitCsv = fullfile(outDir, 'Step05I_OffsetTilt_Shared_Response_Surface_Fit_20251222.csv');
tiltCsv = fullfile(outDir, 'Step05I_OffsetTilt_Shared_Response_Surface_Tilt_20251222.csv');
summaryCsv = fullfile(outDir, 'Step05I_OffsetTilt_Shared_Response_Surface_BladeSummary_20251222.csv');
figFile = fullfile(figDir, 'Step05I_OffsetTilt_Shared_Surface_20251222.png');
