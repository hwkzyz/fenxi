# step07jcore MATLAB helpers for 20251222

This folder-local package makes the 20251222 gap-aware route self-contained.
...
- Step07J mainline loads fixed joint static eta from the folder-local
  `Step07J_FixedJointEtaPrior_20251222.m`; MAT-file loading is retained
