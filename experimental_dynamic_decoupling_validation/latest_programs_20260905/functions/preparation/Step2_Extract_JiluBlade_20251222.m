function summary_table = Step2_Extract_JiluBlade_20251222(target_cases, show_plots)
%STEP2_EXTRACT_JILUBLADE_20251222 Original-like Step2 for 20251222 dynamic cases.
...
config_path = fullfile(cfg.reference_output_dir, 'Sensor_Config_20251222.mat');
if ~isfile(config_path)
    Step1_Build_Sensor_Config_20251222();
end
...
for iCase = 1:numel(target_cases)
    ...
    writetable(case_summary, fullfile(output_dir, 'Step2_Summary_20251222.csv'));
    save(fullfile(output_dir, 'Step2_Summary_20251222.mat'), 'case_summary');
...
fprintf('>>> [Step2][%s] OPR pulses=%d, revolutions鈮?d\n', ...
...
figure('Name', sprintf('20251222 Step2 RPM - %s', case_name), ...
...
fig2 = figure('Name', sprintf('20251222 Step2 Blade ID Sequence - %s', case_name), ...
...
fig3 = figure('Name', sprintf('20251222 Step2 First-Lap Fingerprint - %s', case_name), ...
...
fig4 = figure('Name', sprintf('20251222 Step2 Revolution Shift Path - %s', case_name), ...
...
figure('Name', sprintf('20251222 Step2 Summary Table - %s', case_name), ...
