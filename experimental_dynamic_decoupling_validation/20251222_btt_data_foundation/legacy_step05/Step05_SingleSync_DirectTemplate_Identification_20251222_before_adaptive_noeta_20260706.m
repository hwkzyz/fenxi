...
method.vp_fit_bundle_split = ['VP screens EO on a main-pulse/dynamic-effective/query-safe bundle; ' ...
    'final full-waveform RMSE is evaluated on the full query-safe or phase-safe waveform bundle'];
