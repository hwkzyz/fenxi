# step07jcore MATLAB helpers for 20250527

This folder-local package makes the 20250527 gap-aware route self-contained.
...
- Step07J mainline loads fixed joint static eta from the folder-local
  `Step07J_FixedJointEtaPrior_20250527.m`; MAT-file loading is retained
