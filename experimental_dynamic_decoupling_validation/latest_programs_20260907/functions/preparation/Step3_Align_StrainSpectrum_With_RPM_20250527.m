function result = Step3_Align_StrainSpectrum_With_RPM_20250527(case_name, base_alignment_offset_sec, order_candidates, freq_plot_hz, show_plots, strain_preprocess_method)
...
if nargin < 6 || isempty(strain_preprocess_method)
