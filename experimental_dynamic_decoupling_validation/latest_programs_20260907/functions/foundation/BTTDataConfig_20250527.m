...
route_dir = packageCfg.paths.root;
...
% Package-owned paths override the legacy path literal.
...
cfg.output_root = fullfile(packageCfg.paths.preparedInputs, 'foundation');
...
cfg.blades_num = 6;
% Explicit OPR semantics for speed/phase reconstruction. Keep this
% independent from blades_num even when the current experiment uses the
...
cfg.step05_opr_events_per_revolution = cfg.opr_events_per_revolution;
