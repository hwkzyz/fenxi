%% Visualize strain-BTT validation (20250527)
...
cfg.analysis_start_time = packageCfg.case.analysisStartTimeSec;
cfg.method_name = packageCfg.model.mainGapModel;
cfg.primary_strain_channel = packageCfg.strain.primaryChannel;
cfg.method_result_file = packageCfg.files.formalGapResult;
cfg.show_figures = packageCfg.run.showPlots;
cfg.save_figures = packageCfg.run.saveFigures;
cfg.figure_dir = packageCfg.paths.figures;
cfg.figure_style = 'nature';
cfg.export_pdf = true;
cfg.zoom_half_width_ms = 0.35;
cfg.enable_strain_reference = true;
% FE transfer ratio at the inferred strain-gauge centre (X=4.00 mm,
% Z=2.800 mm) in the 580 Hz straight-blade model.
...
cfg.fe_transfer_ratio_label = sprintf('580 Hz FE, R=%.3f 1/m', ...
    packageCfg.strain.transferRatio1PerM);
cfg.fe_transfer_ratio_1_per_m = packageCfg.strain.transferRatio1PerM;
cfg.strain_to_tip_mm = 1 / cfg.fe_transfer_ratio_1_per_m / 1000;
cfg.strain_alignment_file = fullfile(packageCfg.paths.results, ...
    'Step04_BTT_STE_Resonance_Regions_20250527.mat');
cfg.low_speed_strain_dir = 'E:\试验数据\20250527\应变片数据20250527\20250527_900';
cfg.low_speed_strain_file = '';
cfg.low_speed_strain_dir = fullfile('E:\', '试验数据', '20250527', ...
    '应变片数据20250527', '20250527_900');
...
StrainRef04 = build_step6_strain_reference_local(Result, cfg, 'AI1-04');
...
alignment_file = fullfile(cfg.project_dir, 'output', case_name, 'Step3_Spectrum_RPM_Alignment_20250527.mat');
end
