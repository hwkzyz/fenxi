...
figDir = fullfile(outDir, 'figures_projection_trust_region');
...
if isempty(resultSuffixOverride)
    resultSuffixOverride = 'diag_projection_trust_region_20260729';
end
...
elseif strcmpi(cfg.localBundleSource, 'foundation_step05_bundle')
    ...
    dynamicFile = find_step06_highmap_file_local(formalGapResultDir, C0.dataset, C0.caseTag, expectedAnalysisStartTime);
...
if strcmpi(cfg.runMode, 'comparison')
    ...
    Result.method = 'gap_fixed_tilt_main_projection_limited_vp_full_wave';
end
...
Result.gapCalibrationIndexFile = find_gap_calibration_index_file_local(formalGapResultDir, C0);
