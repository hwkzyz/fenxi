function result = Step3_Displacement_Calculation_20250527(case_name, alignment_offset_sec, show_plots)
%STEP3_DISPLACEMENT_CALCULATION_20250527 Step3-style synchronized display for 20250527.
...
sensor_config_path = fullfile(cfg.reference_output_dir, 'Sensor_Config_20250527.mat');
if ~isfile(sensor_config_path)
    error('Step3 requires Sensor_Config_20250527.mat. Missing file: %s', sensor_config_path);
end
...
if ~show_plots
    save(fullfile(btt_output_dir, 'Step3_Result_20250527.mat'), 'result');
    return;
end
...
alignment_path = fullfile(output_dir, 'Step3_Spectrum_RPM_Alignment_20250527.mat');
...
switch char(case_name)
    case '20250526_3150'
        strain_case_dir = fullfile(strain_root, '20250527_3150');
    case '20250526_910'
        strain_case_dir = fullfile(strain_root, '20250527_900');
    case '20250526_2500-3500_t200'
        strain_case_dir = fullfile(strain_root, '20250527_2500_3500_time200');
    case '20250526_2500-3500_t400'
        strain_case_dir = fullfile(strain_root, '20250527_2500_3500_time400');
    case '20250526_2500-3500_t800'
        strain_case_dir = fullfile(strain_root, '20250527_2500_3500_time800');
    otherwise
...
fig = figure('Name', sprintf('20250527 Step3 Sync Overview - %s', case_name), ...
...
figure('Name', sprintf('20250527 Step3 Strain STFT - %s', case_name), ...
...
figure('Name', sprintf('20250527 Step3 Local FFT - %s', case_name), ...
