...
flow_cfg = ProjectionFlow_Config_20250527();
...
cfg.analysis_start_time = flow_cfg.identification.analysisStartTimeSec;
cfg.target_laps = flow_cfg.identification.targetBladePasses;
cfg.analysis_win_size = flow_cfg.identification.windowBladePasses;
cfg.sliding_step = flow_cfg.identification.slidingStepBladePasses;
...
cfg.poly_order = 5;
cfg.pulse_window_sec = flow_cfg.identification.pulseWindowSec;
