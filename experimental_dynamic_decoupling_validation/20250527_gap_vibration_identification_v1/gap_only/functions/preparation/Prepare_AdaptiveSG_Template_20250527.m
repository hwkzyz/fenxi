function [Template, Diagnostics, outputFile] = Prepare_AdaptiveSG_Template_20250527(forceRebuild)
%PREPARE_ADAPTIVESG_TEMPLATE_20250527 Build the formal adaptive-SG template.
...
writetable(Diagnostics.selection, fullfile(fileparts(outputFile), ...
    'AdaptiveSG_Selection_20250527.csv'));
writetable(Diagnostics.sensor, fullfile(fileparts(outputFile), ...
    'AdaptiveSG_SensorSummary_20250527.csv'));
