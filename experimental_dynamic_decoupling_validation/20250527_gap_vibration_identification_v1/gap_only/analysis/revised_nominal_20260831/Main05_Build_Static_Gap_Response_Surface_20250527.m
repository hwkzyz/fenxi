...
speedSummaryFile = fullfile(packageCfg.paths.results, 'Step05A_single_gap_speed_summary', ...
    'Step05A_Average_Calibration_Speed.csv');
if ~exist(outDir, 'dir')
    mkdir(outDir);
end

targetBladeMode = 'explicit_reference';  % fixed physical reference blade
explicitReferenceBladeId = 2;
