...
% are evaluated as 4-lap windows with a 1-lap sliding step.
...
cfg.step05_window_laps = 4;
cfg.step05_sliding_step_laps = 1;
cfg.step05_freq_search_hz = [0 1000];
...
cfg.step05_legacy_template_library_file = fullfile( ...
    cfg.route_dir, '..', '20241106_low_speed_rotating_calibration', ...
    'output', 'new_flow', '05A_low_speed_template_library', 'S2357', ...
    'LowSpeedTemplateLibrary_20241106.mat');
cfg.step05_timing_source = 'step02';
cfg.step05_legacy_pulse_dir = fullfile( ...
    cfg.route_dir, '..', '20241106_low_speed_gap_prior_decoupling', ...
    'legacy', 'output', '3000_3150');
