function SummarySet = Build_Step05_FixedEta_FromFreeEtaPilot_20241106()
%BUILD_STEP05_FIXEDETA_FROMFREEETAPILOT_20241106
...
fprintf('\n=== Build fixed eta from FreeEta pilot (20241106) ===\n');
...
for ib = 1:numel(target_blades)
    ...
    Free = Compare_Step05_FreeEta_20241106();
...
summary_csv = fullfile(preview_dir, ...
    'Step05_FixedEta_FromFreeEtaPilot_20241106.csv');
