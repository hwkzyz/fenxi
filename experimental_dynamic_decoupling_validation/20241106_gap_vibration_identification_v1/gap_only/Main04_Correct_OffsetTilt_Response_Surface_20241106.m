%% 04: correct the shared response surface for blade offset and tilt
...
addpath(thisDir, fullfile(thisDir, 'functions', 'utilities'));
...
offsetFile = packageCfg.paths.bladeOffsetFile;
...
matFile = fullfile(outDir, 'Step05I_OffsetTilt_Shared_Response_Surface_20241106.mat');
fitCsv = fullfile(outDir, 'Step05I_OffsetTilt_Shared_Response_Surface_Fit_20241106.csv');
tiltCsv = fullfile(outDir, 'Step05I_OffsetTilt_Shared_Response_Surface_Tilt_20241106.csv');
summaryCsv = fullfile(outDir, 'Step05I_OffsetTilt_Shared_Response_Surface_BladeSummary_20241106.csv');
figFile = fullfile(figDir, 'Step05I_OffsetTilt_Shared_Surface_20241106.png');
