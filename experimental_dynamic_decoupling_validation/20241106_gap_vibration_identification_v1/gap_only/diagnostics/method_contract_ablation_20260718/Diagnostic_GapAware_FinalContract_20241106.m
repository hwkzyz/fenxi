...
% Diagnostic copy only: strict Top-3 Foundation plus current-window two-pass bundle.
...
setenv('STEP07J_PHASE_SAFE_EXPANSION', '1');
setenv('STEP07J_PREV_WINDOW_CANDIDATE_MODE', 'off');
setenv('STEP07J_RESULT_SUFFIX', '_diag_finalcontract_top3_currentwindow');
...
packageFoundationFile = fullfile(packageConfig.paths.foundationResults, ...
    'diag_contract_top3_phasesafe', packageConfig.case.dynamicCase, sprintf( ...
