%% 03: build static gap response surface for 20241106
...
libraryDir = packageCfg.paths.staticGapWaveformLibrary;
...
responseSurface.dataset = '20241106';
...
%% 5. Save outputs
matFile = fullfile(outDir, 'Step05_Response_Surface_20241106.mat');
csvFile = fullfile(outDir, 'Step05_Response_Surface_Fit_20241106.csv');
save(matFile, 'responseSurface', '-v7.3');
motionCsvFile = fullfile(outDir, 'Step05_Calibration_Motion_20241106.csv');
baselineCsvFile = fullfile(outDir, 'Step05_Static_Gap_Continuous_Baseline_20241106.csv');
...
%% 6. Diagnostics
if saveFigures
    fig = figure('Name', '20241106 Step05 response surface', ...
    ...
    figFile = fullfile(outDir, 'Step05_Response_Surface_20241106.png');
    saveas(fig, figFile);
end
