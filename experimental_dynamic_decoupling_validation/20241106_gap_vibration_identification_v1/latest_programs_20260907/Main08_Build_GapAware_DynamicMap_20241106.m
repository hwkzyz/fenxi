%% 08: build the gap-aware DynamicMap for 20241106
...
addpath(routeDir, fullfile(routeDir, 'functions', 'foundation'), ...
    fullfile(routeDir, 'functions', 'preparation'), ...
    fullfile(routeDir, 'functions', 'gap_aware'), ...
    fullfile(routeDir, 'functions', 'utilities'));
...
P.templateFile = '';
P.correctedLibFile = '';
runtimeTemplateBank = fullfile(packageCfg.paths.calibrationRuntime, ...
    Flow.calibration.runtimeTemplateBankFile);
runtimeGapBank = fullfile(packageCfg.paths.calibrationRuntime, ...
    Flow.calibration.runtimeGapBankFile);
bundledTemplateBank = fullfile(packageCfg.paths.calibrationGap, ...
    Flow.calibration.templateBankFile);
bundledGapBank = fullfile(packageCfg.paths.calibrationGap, ...
    Flow.calibration.gapBankFile);
P.templateBankFile = first_existing_file_local(runtimeTemplateBank, bundledTemplateBank);
P.gapBankFile = first_existing_file_local(runtimeGapBank, bundledGapBank);
...
%% Local functions
function file = first_existing_file_local(primaryFile, fallbackFile)
