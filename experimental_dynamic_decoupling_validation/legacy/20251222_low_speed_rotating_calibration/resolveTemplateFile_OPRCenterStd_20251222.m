function [templateFile, sourceMode] = resolveTemplateFile_OPRCenterStd_20251222(routeDir, C, templateSuffix)
...
candidates = {
    sprintf('Template_LowSpeedRotating_%s_GradientXRange030_OPRCenterStd_20251222.mat', caseTag)
    sprintf('Template_LowSpeedRotating_%s_GradientXRange030_OPRAnchored_20251222.mat', caseTag)
    sprintf('Template_LowSpeedRotating_%s_GradientXRange030_20251222.mat', caseTag)
    sprintf('Template_LowSpeedRotating_%s_20251222.mat', caseTag)
    sprintf('Template_LowSpeedRotating_%s_GradientXRange030_BaseFrame_20251222.mat', caseTag)
    };
