...
P.name.resultSuffix = sprintf('%s_Main_DirectTemplate_OPRCenterStd_Dx035_WithEta020_Reg005_PrevWinPhaseSafe', ...
    resonanceSelection.shortTag);
...
P.step03.sensorEtaAdaptiveScaleTable = [];
P.step03.sensorEtaRegWeightVPerMM = 0.05;
...
if isfield(loaded_dynamic.DynamicMap, 'ResonanceSelection')
    Result.ResonanceSelection = loaded_dynamic.DynamicMap.ResonanceSelection;
else
