%% Step04_Visualize_Identification_Results_20251222
% Visualization script for the stabilized Step03 identification results.
%
% Inputs:
%   output/identification/Result_ProposedFixedTemplateSliding_B1_S123_20251222.mat
%
% Outputs:
...
for k = 1:numel(sensor_tags)
    result_file = fullfile(result_dir, sprintf( ...
        'Result_ProposedFixedTemplateSliding_B%d_%s_20251222.mat', ...
