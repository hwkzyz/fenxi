%% Step04_Main_Visualize_GradientXRange030_20251222
...
result_file = fullfile(result_dir, sprintf( ...
    'Result_Step03_Main_VPTop3SynchronousWaveform_B1_S123_%s_20251222.mat', result_suffix));
if exist(result_file, 'file') ~= 2
    error(['Main Step03 result not found:\n  %s\n' ...
        'Run Step03_Main_Run_GradientXRange030_Identification_20251222 first.'], result_file);
end
...
fig = figure('Name', '20251222 main identification trend', 'Color', 'w', ...
...
png_file = fullfile(figure_dir, 'Step04_Main_GradientXRange030_Trend_20251222.png');
pdf_file = fullfile(figure_dir, 'Step04_Main_GradientXRange030_Trend_20251222.pdf');
...
summary_csv = fullfile(result_dir, 'Step04_Main_GradientXRange030_Summary_20251222.csv');
