%% Step03_Diag_AllSoft_OPRCenterStd_NoEta_20251222
...
P.name.resultSuffix = 'Diag_AllSoft_OPRCenterStd_NoEta';
...
P.step03.pulseMode = 'all';
P.step03.domainSelectionMode = 'soft';
P.step03.domainSoftMarginMM = 0.20;
