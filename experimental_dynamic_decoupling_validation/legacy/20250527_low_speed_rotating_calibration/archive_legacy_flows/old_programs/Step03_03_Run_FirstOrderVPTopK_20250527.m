%% Step03_03_Run_FirstOrderVPTopK_20250527
% First-order template-VP/top-K accelerated low-speed-template-only
% identification using the same final waveform objective as Step03_01.
%
...
cfg.debug_max_windows = parse_positive_integer_env_local('STEP03_03_MAX_WINDOWS', inf);
cfg.vp_top_k_eo = parse_positive_integer_env_local('STEP03_03_TOP_K_EO', 5);
...
result_file = fullfile(result_dir, sprintf('Result_Step03_03_FirstOrderVPTopK_B%d_%s_20250527.mat', ...
...
fprintf('\n=== Step03_03: first-order VP top-K identification ===\n');
