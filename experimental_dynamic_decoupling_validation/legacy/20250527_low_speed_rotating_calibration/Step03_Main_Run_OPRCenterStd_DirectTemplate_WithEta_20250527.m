...
% Main direct-template identification with eta_s enabled.
...
P.step03.sensorEtaLimitMM = 0.20;
...
P.step03.sensorEtaRegWeightVPerMM = 0.02;
...
fprintf('\n=== Step03 main: direct-template identification with eta_s ===\n');
...
%% Step03_Main_VPTop3SynchronousWaveform_WithEta_20250527
...
patterns = {
    sprintf('Template_LowSpeedRotating_%s_GradientXRange030_OPRAnchored_20250527.mat', case_tag)
    sprintf('Template_LowSpeedRotating_%s_GradientXRange030_20250527.mat', case_tag)
    sprintf('Template_LowSpeedRotating_%s_20250527.mat', case_tag)
...
case_tag = sprintf('B%d_%s', target_blade, sensor_tag);
patterns = {
    sprintf('DynamicMap_%s_SlidingWindows_20250527.mat', case_tag)
    sprintf('DynamicMap_%s_SlidingWindows_GradientXRange030_20250527.mat', case_tag)
