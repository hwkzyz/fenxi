%% Run_All_Blades_OPRCenterStd_20250527
...
for i = 1:numel(bladeIds)
    ...
    summaryFile = fullfile(routeDir, 'output', 'identification', ...
    ...
    if ~isfile(summaryFile)
        ...
        run(fullfile(routeDir, 'Step00_Build_CoverageFirstStableWindowPlan_20250527.m'));
        run(fullfile(routeDir, 'Run_Main_OPRCenterStd_20250527.m'));
    else
...
summaryFile = fullfile(routeDir, 'output', 'identification', ...
    'BatchSummary_AllBlades_OPRCenterStd_20250527.csv');
